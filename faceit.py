...
from lib.util import FullHelpArgumentParser
...
if __name__ == '__main__':
    faceit = FaceIt('liuyifei_to_yangmi', 'liuyifei', 'yangmi')
    faceit.add_video('liuyifei', 'liuyifei-1.mp4', 'https://www.youtube.com/watch?v=VtXJPpAhUBM')

    faceit.add_video('yangmi', 'yangmi—1.mp4', 'https://www.youtube.com/watch?v=EuFZFLGlIXI')
